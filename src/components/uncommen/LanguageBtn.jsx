...
const LanguageBtn = () => {
  ...
  return (
    ...
    <button
      ...
      className="lang max-sm:mt-[180px] sm:mt-9 p-1 sm:px-3 w-fit sm:py-2 flex items-center max-sm:justify-center gap-2 text-white cursor-pointer border-2 border-white rounded-full"
    ...
    {isOpen && (
      <div className="absolute bottom-full right-0 mt-2 w-40 bg-white dark:bg-gray-800 rounded-lg shadow-xl py-2">
